...
#define UART_TX_BUSY			((spp_tx_fifo.rptr != spp_tx_fifo.wptr) || uart_send_flag)
...
//////////////////////////// BLE stack Initialization  Begin //////////////////////////////////
	...
	#elif (MCU_CORE_TYPE == MCU_CORE_B92)
		uart_set_pin(UART0, UART0_TX_PIN ,UART0_RX_PIN );// uart tx/rx pin set
	#endif
