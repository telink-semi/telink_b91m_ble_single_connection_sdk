...
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_52_BYTES)
	#define ACL_CONN_MAX_TX_OCTETS			52	//user set value
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_56_BYTES)
	#define ACL_CONN_MAX_TX_OCTETS			56	//user set value
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_100_BYTES)
	#define ACL_CONN_MAX_TX_OCTETS			100	//user set value
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_200_BYTES)
	#define ACL_CONN_MAX_TX_OCTETS			200	//user set value
#elif (DLE_LENGTH_SELECT == DLE_LENGTH_251_BYTES)
...
#if (MCU_CORE_TYPE == MCU_CORE_B91 && DLE_LENGTH_SELECT == DLE_LENGTH_251_BYTES)
	#define ACL_TX_FIFO_NUM				9	//user set value
#else
	#define ACL_TX_FIFO_NUM				17	//user set value
#endif
