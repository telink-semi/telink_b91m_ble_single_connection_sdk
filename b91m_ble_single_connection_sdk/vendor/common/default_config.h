...
#ifndef  PM_DEEPSLEEP_RETENTION_SIZE
#define PM_DEEPSLEEP_RETENTION_SIZE	 0x8000
#endif

#if (MCU_CORE_TYPE == MCU_CORE_B91)
#if PM_DEEPSLEEP_RETENTION_SIZE != 0x8000 &&  PM_DEEPSLEEP_RETENTION_SIZE != 0x10000
#error ”Deep retention size setting err!“
#endif
#endif

#if (MCU_CORE_TYPE == MCU_CORE_B92)
#if PM_DEEPSLEEP_RETENTION_SIZE != 0x8000 &&  PM_DEEPSLEEP_RETENTION_SIZE != 0x10000 \
	&& PM_DEEPSLEEP_RETENTION_SIZE == 0x18000
#error ”Deep retention size setting err!“
#endif
#endif
