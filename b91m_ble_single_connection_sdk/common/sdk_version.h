 ...
 */
#define B91M_SDK_VERSION_NUM				V3.3.0.0
#define SDK_VERSION_NUM					B91M_SDK_VERSION_NUM



#define	SDK_VERSION1(sdk_version_num)	"$$$b91m_ble_single_connect_sdk_"#sdk_version_num"$$$"
