 ...
 *********************************************************************************************************************/
/**
 *  @note	If it is built-in flash, the maximum speed of mspi is 64M.
...
#define CCLK_96M_HCLK_48M_PCLK_24M_MSPI_48M	clock_init(PLL_CLK_192M, PAD_PLL_DIV, PLL_DIV2_TO_CCLK, CCLK_DIV2_TO_HCLK, HCLK_DIV2_TO_PCLK, PLL_DIV4_TO_MSPI_CLK)
//The following is only available with built-in flash.
