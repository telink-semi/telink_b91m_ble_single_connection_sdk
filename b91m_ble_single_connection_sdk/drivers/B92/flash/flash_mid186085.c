 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
void flash_write_status_mid186085(unsigned short data, mid186085_write_status_bit_e bit)
{
	/*
...
void flash_lock_mid186085(mid186085_lock_block_e data)
{
	...
	flash_write_status_mid186085(data, FLASH_WRITE_STATUS_BP_MID186085);
}
...
{
	flash_write_config_mid186085(0x00,FLASH_WRITE_CONFIGURE_WPS_MID186085);
	flash_write_status_mid186085(FLASH_LOCK_NONE_MID186085, FLASH_WRITE_STATUS_BP_MID186085);
}
