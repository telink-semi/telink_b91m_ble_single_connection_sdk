 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
void flash_write_status_mid1560c8(unsigned short data, mid1560c8_write_status_bit_e bit)
{
	/*
	 * qe_enable:  data -> 0x200,
	 * qe_disable: data -> 0x00.
	 */
...
{
	flash_write_status_mid1560c8(data, FLASH_WRITE_STATUS_BP_MID1560c8);
}
...
{
	flash_write_status_mid1560c8(FLASH_LOCK_NONE_MID1560c8, FLASH_WRITE_STATUS_BP_MID1560c8);
}
