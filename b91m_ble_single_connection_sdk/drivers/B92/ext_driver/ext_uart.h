...
#define TLKAPI_DEBUG_UART_TX_PIN    			 	GPIO_FC_PC7
#endif

#ifndef TLKAPI_DEBUG_UART_RX_PIN
#define TLKAPI_DEBUG_UART_RX_PIN     				GPIO_FC_PC6
#endif
...
#define UART_DEBUG_CHECK_TX_DONE_IRQ_STATUS		uart_get_irq_status(TLKAPI_DEBUG_UART_PORT,UART_TXDONE_IRQ_STATUS)
#define UART_DEBUG_CLEAR_TX_DONE				uart_clr_irq_status(TLKAPI_DEBUG_UART_PORT, UART_TXDONE_IRQ_STATUS)
