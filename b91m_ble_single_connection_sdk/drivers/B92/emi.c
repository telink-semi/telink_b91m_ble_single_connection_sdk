 ...
 * @param[in]	none.
 * @return		none.
 * @note  The following configurations are required for RF current testing:
 ...
 *        3.Switch the system clock source from RC 24M to PAD 24M.
 *        4.Power down usb,npe
 *        5.Power down of 24MHz RC oscillator
 *        6.Power down bbpll ldo,sram ldo,digital core ldo
 *        7.MCU stall
 */
_attribute_ram_code_sec_noinline_ void rf_minimum_current_test_cfg(void)
{
	//system_dis
	...
	write_reg8(0x1401e1, 0x08);//reset algm,chg/stimer/dma/pke/gspi/spislv
	...
	write_reg8(0x1401e8,0x92);//System clock switching:PAD 24M
					          //This operation is to switch the system clock source from RC 24M to PAD 24M.
						      //Before that, it is necessary to ensure that the default system clock is normal
	...
	analog_write_reg8(0x06, 0xff); //Power down bbpll ldo,Power down of sram ldo,Power down of digital core ldo
