...
/**
  ...
  * @return    none
  */
_attribute_ram_code_ void mspi_wait(void){
 ...
 * @return    none
 */
_attribute_ram_code_ void mspi_fm_rd_en(void){
 ...
 * @return    none
 */
_attribute_ram_code_ void mspi_fm_rd_dis(void){
	reg_mspi_fm &= ~FLD_MSPI_RD_TRIG_EN;
}
 ...
 * @return    none
 */
_attribute_ram_code_ void mspi_high(void){
 ...
 * @return    none
 */
_attribute_ram_code_ void mspi_low(void){
	reg_mspi_fm &= ~FLD_MSPI_CSN;
}
 ...
 * @return    none
 */
_attribute_ram_code_ void mspi_fm_write(unsigned char c){
	reg_mspi_fm = c;
}
 ...
 * @return    the spi data.
 */
_attribute_ram_code_ unsigned char mspi_get(void){
 ...
 * @return    none
 */
_attribute_ram_code_ void mspi_write(unsigned char c){
	reg_mspi_data = c;
}
 ...
 * @return    read reault.
 */
_attribute_ram_code_ unsigned char mspi_read(void){
