...
#define convert_ram_addr_cpu_to_bus(addr)  ((u32)((((u32)addr) >=0x80000)?(((u32)addr)- 0x80000 + 0xc0200000) : (((u32)addr) + 0xc0000000)))
#define convert_ram_addr_bus_to_cpu(addr)  ((u32)((((u32)addr) >=0xc0200000)?(((u32)addr) + 0x80000 - 0xc0200000) : (((u32)addr) - 0xc0000000)))
